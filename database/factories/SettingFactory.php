...
$factory->define(App\Setting::class, function (Faker $faker) {
	return [
		...
		'home_page_content' => 'ClusterCoding is among the pioneers in the Bangladesh to offer quality web services to medium and large sized businesses to compete in today’s digital world. We possess the experience and expertise to help web entrepreneurs reach their customers across the digital space';
